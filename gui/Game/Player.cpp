...
zappyGUI::Player::Player(zappyGUI::Player& other)
{
    this->_id = other.getId();
    this->_inventory = other.getInventory();
    this->_logs = other.getLogs();
    this->_lvl = other.getLvl();
    this->_name = other.getName();
    this->_spellInProgress = other.getSpellInProgress();
    this->_visionData = other.getVisionData();
}
...
std::vector <zappyGUI::IRessource> zappyGUI::Player::getInventory()
{
...
void zappyGUI::Player::setInventory(std::vector <zappyGUI::IRessource> newVal)
{
